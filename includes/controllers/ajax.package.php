<?php 
	...
	{			
		...
		case "addSubpackage":
			...
			$record->U 	= !empty($_REQUEST['U'])?$_REQUEST['U']:'';
			$record->Double_U 	= !empty($_REQUEST['Double_U'])?$_REQUEST['Double_U']:'';
			$record->Round 	= !empty($_REQUEST['Round'])?$_REQUEST['Round']:'';
			$record->Theatre 	= !empty($_REQUEST['Theatre'])?$_REQUEST['Theatre']:'';
