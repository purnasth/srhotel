...
class Bookinginfo extends DatabaseObject {
	...
	protected static $db_fields = array('id', 'accesskey', 'person_checkin', 'person_first', 'person_last', 'person_email', 'person_country', 'person_country_code', 'person_city', 'person_address', 'person_zipcode', 'person_contact', 'person_message', 'ip_address', 'pay_type', 'transaction_code', 'status', 'sortorder', 'added_date', 'confirm_ip', 'confirm_date' );
	
	public $id;
	public $accesskey;
	public $person_checkin;
	public $person_first;
	public $person_last;
	public $person_email;
