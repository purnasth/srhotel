...
class Config extends DatabaseObject {
	...
	protected static $db_fields = array('id', 'sitetitle', 'city_office_address' , 'icon_upload', 'logo_upload','whatsapp_a','default_banner_upload', 'sitename', 'location_type', 'location_map', 'location_image', 'fiscal_address', 'mail_address', 'contact_info', 'fax', 'email_address', 'breif', 'copyright', 'meta_title', 'site_keywords', 'site_description', 'google_anlytics', 'schema_code', 'book_type', 'hotel_code', 'hotel_page', 'template', 'admin_template','headers','footer','search_box','search_result', 'action');
