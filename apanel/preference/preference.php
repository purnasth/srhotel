    ...
    <div class="example-code">
    	<form action="" class="col-md-12 center-margin" id="Preference_frm">
            ...
            <div class="form-row">
                ...
                <div class="form-input col-md-6">
                    <input placeholder="City Office Address" class="col-md-6 validate[length[0,200]]" type="text"
                           name="city_office_address" id="city_office_address"
                           value="<?php echo !empty($PrefeRow->city_office_address) ? $PrefeRow->city_office_address : ""; ?>">
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <?php if(!empty($PrefeRow->default_banner_upload)):?>
                <div class="col-md-2" id="removeSavedimg3">
                    <div class="infobox info-bg">                            	                                
                        <div class="button-group" data-toggle="buttons">
                            <span class="float-left">
                                <?php 
                                    if(file_exists(SITE_ROOT."images/preference/banner/".$PrefeRow->default_banner_upload)):
                                        $filesize = filesize(SITE_ROOT."images/preference/banner/".$PrefeRow->default_banner_upload);
                                        echo 'Size : '.getFileFormattedSize($filesize);
                                    endif;
                                ?>
                            </span> 
                            <a class="btn small float-right" href="javascript:void(0);" onclick="deleteSavedPreferenceimage(3);">
                                <i class="glyph-icon icon-trash-o"></i>
                            </a>                                                       
                        </div>
                        <img src="<?php echo IMAGE_PATH.'preference/banner/thumbnails/'.$PrefeRow->default_banner_upload;?>"  style="width:100%"/>                                                                                   
                        <input type="hidden" name="imageArrayname3" value="<?= $PrefeRow->default_banner_upload; ?>" class="" />
                    </div> 
                </div>
                <?php endif;?>
                <div class="form-input col-md-10 uploader3 <?php echo !empty($PrefeRow->default_banner_upload)?"hide":"";?>">          
                   <input type="file" name="default_banner_upload" id="default_banner_upload" class="transparent no-shadow">
                   <label><small>Image Dimensions (1920 px X 438 px)</small></label>
                </div>                
...
<script type="text/javascript">
   // <![CDATA[
	...
	// For Banner upload
	$('#default_banner_upload').uploadify({
		'swf'  : '<?php echo ASSETS_PATH;?>uploadify/uploadify.swf',
		'uploader'   : '<?php echo ASSETS_PATH;?>uploadify/uploadify.php',
		'formData'   : {PROJECT : '<?php echo SITE_FOLDER;?>',targetFolder:'images/preference/banner/',thumb_width:200,thumb_height:200},
		'method'     : 'post',
		'cancelImg'  : '<?php echo BASE_URL;?>uploadify/cancel.png',
		'auto'       : true,
		'multi'      : false,	
	   ...
	   /* 'checkExisting' : '/uploadify/check-exists.php',*/
		'onUploadSuccess' : function(file, data, response) {
			var filename =  data;
			$.post('<?php echo BASE_URL;?>apanel/preference/uploaded_image3.php',{imagefile:filename},function(msg){			
