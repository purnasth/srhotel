...
<div class="col-md-2" id="previewUserimage<?php echo $deleteid;?>">
    <div class="infobox info-bg">
        <img src="<?php echo IMAGE_PATH.'preference/banner/thumbnails/'.$val;?>"  style="width:100%"/>
...
//uplodify
  if(isset($_SESSION['imageNameArr'])){
   if(count($_SESSION['imageNameArr'])>0){
      ...
      { 
         @unlink(IMAGE_PATH.'preference/banner/thumbnails/'.$val);
      	 @unlink(IMAGE_PATH.'preference/banner/'.$val);
      }	 
