...
$position = array(1 => 'Top Menu 1', 4 => 'Top Menu 2', 2 => 'Explore Menu', 3 => 'Quick Link Menu');
                ...
                foreach ($records as $record): ?>
                    <tr id="<?php echo $record->id; ?>">
                        ...
                        <td>
                            ...
                            if ($submenu):
                                ?>
                                <a href="javascript:void(0);" title="title" onClick="displaySubMenu(<?php echo $record->id; ?>,'<?php echo $record->name; ?>')"
            ...
            <form action="" class="col-md-10 center-margin" id="menu_frm">
                <div class="form-row">
                    ...
                    <div class="form-input col-md-10">
                        <input placeholder="Menu Name" class="col-md-4 validate[required,length[0,50]]" type="text" name="name" id="name"
                               value="<?php echo !empty($menu->name) ? $menu->name : ""; ?>">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-label col-md-2">
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-8">
                        <div class="col-md-4" style="padding-left:0px !important;">
                            <input placeholder="Menu Link" class="validate[required,length[0,50]]" type="text" name="linksrc" id="linksrc"
