    ...
    <div class="example-code">
    	<form action="" class="col-md-12 center-margin" id="location_frm">
            ...
            <div class="form-row">
                ...
                <div class="form-input col-md-20">
                    <input placeholder="Contact Info" class="col-md-6" type="text" name="whatsapp_a" id="whatsapp_a" value="<?php echo !empty($locationRow->whatsapp_a)?$locationRow->whatsapp_a:"";?>">
                </div>                
            </div>
            <div class="form-row">
                <div class="form-label col-md-2">
