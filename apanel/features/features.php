    ...
    <div class="example-code">
        <form action="" class="col-md-12 center-margin" id="features_frm">
            ...
            <div class="form-row">
                ...
                <div class="form-input col-md-6">
                    <input placeholder="fa icon" class="col-md-8" type="text" name="fa_icon" id="fa_icon" value="<?php echo !empty($featuresInfo->fa_icon)?htmlentities($featuresInfo->fa_icon):"";?>">&nbsp;OR
                </div>                
            </div>                             
