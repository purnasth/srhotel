    ...
    if (jQuery(".form_subscribe")[0]) {
        ...
        jQuery(".form_subscribe").validate({
            ...
            submitHandler: function(form) {
                ...
                return jQuery("#btn-submit").attr("disabled", "true"), jQuery.ajax({
                    type: "POST",
                    dataType: "JSON",
                    ...
                    success: function(data) {
                        var msg = eval(data);
                        jQuery("#btn-submit").removeAttr("disabled"), jQuery("#result-newsletter").html(msg.message), jQuery(".form_subscribe")[0].reset()
                    }
                }), !1
            }
        })
        ...
        jQuery(".form_subscribepop").validate({
            ...
            submitHandler: function(form) {
                ...
                return jQuery("#btn-submit").attr("disabled", "true"), jQuery.ajax({
                    ...
                    success: function(data) {
                        var msg = eval(data);
                        jQuery("#btn-submit").removeAttr("disabled"), jQuery("#result-newsletterpop").html(msg.message), jQuery(".form_subscribepop")[0].reset()
                    }
                }), !1
            }
        })
