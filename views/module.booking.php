...
// hotel 
if($booking_type==2) {
    $resbking.='<form action="'.BASE_URL.$booking_page.'" method="get" id="hotel-form" >
        ...
        <div class="row">
            ...
            <div class="ser-in-box col-md-4">
                <button onclick="location.href = \'http://longtail.com.np/godavari/contact-us\';" class="button-small-solid" id="btn-book">Book Now</button>
            </div>
        </div>
    </form>';

    $resinbking.='<div class="form-inner row">
	<form action="'.BASE_URL.$booking_page.'" method="get" id="hotel-form" target="_blank">
        <input type="hidden" name="hotel_code" value="'.$booking_code.'">
        <div class="col-md-12">
            <b>Check In</b>
